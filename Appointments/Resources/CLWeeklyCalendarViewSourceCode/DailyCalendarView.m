...
//    }else{
        self.dateLabelContainer.backgroundColor = (blnSelected)?[UIColor grayColor]: [UIColor clearColor];
        
        self.dateLabel.textColor = (blnSelected)?[UIColor whiteColor]:[UIColor grayColor];
//    }
