...
#define DATE_LABEL_INFO_WIDTH 180.f
...
-(void)applyCustomDefaults
{
    ...
    self.dayTitleTextColor = [UIColor grayColor];
    ...
    self.selectedDatePrintColor = [UIColor grayColor];
    ...
    self.backgroundImageColor = [UIColor grayColor];
...
//        strDate = [NSString stringWithFormat:@"Today, %@", strDate ];
          strDate = [NSString stringWithFormat:@"Today"];
    }
